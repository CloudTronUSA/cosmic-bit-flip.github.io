---
title: 'File Struct Exploits Part 1'
description: 'An explanation of how to use File Struct overwrites to gain an Arbitrary Read or Write Primitive.'
date: 2026-04-05
tags: ['pwn', 'file-structs']
authors: ['milrn']
---
...
NOTE: When using pwntools to make Arbitrary Write or Read payloads, ensure `context.arch` is set correctly to avoid pwntools generating incorrect payloads.
